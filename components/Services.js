        ...
        <div>
            ...
            <div className='flex flex-wrap justify-evenly'>
                    ...
                    >
                      ...
                      <p className='text-slate-800 tracking-wide text-center w-96'>Creating elegant design suited for your needs following core design theory.</p>
                    </motion.div>
                    ...
                    >
                      ...
                      <p className='text-slate-800 tracking-wide text-center w-96'>Translating complex requirements into intuitive, user-friendly applications using modern technologies.</p>
                    </motion.div>
                    ...
                    >
                      ...
                      <p className='text-slate-800 tracking-wide text-center w-96'>Giving you strategic advice to boost innovation and efficiency.</p>
                    </motion.div>
            </div>
